...
class Post(models.Model):    # inherits from django.db.models
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE) # on_delete means if User is deleted, then what happens --> well for models.CASCADE means that everything they did is deleted too, but not the other way around
